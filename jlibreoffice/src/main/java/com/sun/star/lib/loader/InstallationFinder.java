 ...
 *  $Revision: 1.3 $
 *
 *  last change: $Author: 205327 $ $Date: 2012/01/02 22:30:25 $
 *
...
public final class InstallationFinder {
    ...
    static {
    	WIN_REGISTRY = new ArrayList<WinRegKeyName>();
    	
    	WIN_REGISTRY.add(new WinRegKeyName(
    			WinRegKeyName.HKEY_CURRENT_USER, 
    			"Software\\OpenOffice.org\\UNO\\InstallPath"));

    	WIN_REGISTRY.add(new WinRegKeyName(
    			WinRegKeyName.HKEY_LOCAL_MACHINE, 
    			"Software\\OpenOffice.org\\UNO\\InstallPath"));
    ...
    private static String getPathFromWindowsRegistry() {
        ...
        for (WinRegKeyName winRegKeyName : WIN_REGISTRY) {
